...
class ZmqTornadoIntegrationTest(unittest.TestCase):
    ...
    def _setup_data_servers(self):
        ...
        data_master_worker = self._settings.ZEROMQ_WORKER_PROC_EXTRACTOR_PUSH
        ...
        data_worker_master = self._settings.ZEROMQ_MASTER_SUB
...
class WorkerScoperTestCase(ZmqTornadoIntegrationTest):
